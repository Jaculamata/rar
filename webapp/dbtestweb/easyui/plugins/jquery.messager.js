...
win.window("window").addClass("messager-0window");
...
return $("body>div.messager-0window").find("div.messager-p-bar");
},close:function(){
var win=$("body>div.messager-0window>div.messager-body:has(div.messager-progress)");
if(win.length){
win.window("close");
}
}};
