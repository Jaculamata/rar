...
var win=$(_18).panel($.extend({},_19.options,{border:false,doSize:true,closed:true,cls:"window",headerCls:"0window-header",bodyCls:"0window-body "+(_19.options.noheader?"0window-body-noheader":""),onBeforeDestroy:function(){
...
_19.mask=$("<div class=\"0window-mask\"></div>").insertAfter(_19.window);
...
_19.shadow=$("<div class=\"0window-shadow\"></div>").insertAfter(_19.window);
...
if(!_21.proxy){
_21.proxy=$("<div class=\"0window-proxy\"></div>").insertAfter(_21.window);
}
...
_21.pmask=$("<div class=\"0window-proxy-mask\"></div>").insertAfter(_21.window);
...
$("body>div.0window-mask").css({width:$(window)._outerWidth(),height:$(window)._outerHeight()});
setTimeout(function(){
$("body>div.0window-mask").css({width:_1e().width,height:_1e().height});
},50);
});
