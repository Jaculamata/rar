...
var win=$(_24e).panel($.extend({},_24f.options,{border:false,doSize:true,closed:true,cls:"window",headerCls:"0window-header",bodyCls:"0window-body "+(_24f.options.noheader?"0window-body-noheader":""),onBeforeDestroy:function(){
...
_24f.mask=$("<div class=\"0window-mask\"></div>").insertAfter(_24f.window);
...
_24f.shadow=$("<div class=\"0window-shadow\"></div>").insertAfter(_24f.window);
...
if(!_256.proxy){
_256.proxy=$("<div class=\"0window-proxy\"></div>").insertAfter(_256.window);
}
...
_256.pmask=$("<div class=\"0window-proxy-mask\"></div>").insertAfter(_256.window);
...
setTimeout(function(){
$("body>div.0window-mask").css({width:_253().width,height:_253().height});
},50);
});
