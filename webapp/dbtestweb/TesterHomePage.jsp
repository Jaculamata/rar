...
<head>
    ...
    <%--<script src="dialogEdit/js/edit.js"></script>--%>
...
//                    addPanel('./codemirror-5.2/mydemo/index.html',node.text);
                    ...
                    if (node.type == 'file'){
                        ...
                        addPanel('./dycontent.jsp?'+params,node.text,node.id);
                    }
...
<div
        data-options="region:'north',title:'header',split:true,noheader:true, disabled:true"
        style="height: 68px; background: #fff;">
    <div id="head" style="background: #2992b1;">
        <i class="e-icon fa fa-fw fa-database on fa-square-o  fa-2x"></i><span class="logo">数据库安全评级工具（测试员）</span>
...
<div id="dlg-buttons">
    <table cellpadding="0" cellspacing="0" style="width: 100%">
        <tr>
            <td>
                <a id="newProjectNextStep" href="#" class="easyui-linkbutton"
                   iconCls="fa fa-save" plain="true">下一步</a>
                <a id="cancelNewProject" href="#" class="easyui-linkbutton" iconCls="fa fa-times" plain="true"
                   onclick="">取消</a>
            </td>
        </tr>
    </table>
...
<div id="importJar" class="easyui-dialog" title="导入驱动jar包" style="width: 300px;height: 180px;padding: 10px"
    ...
    <div id="importJar-btn" style="margin: 30px 0;text-align: center;">
...
<div id="jar-btn">
    <table cellpadding="0" cellspacing="0" style="width: 100%">
        <tr>
            <td>
                <a href="#" id="saveProject" class="easyui-linkbutton" iconCls="fa fa-save" plain="true">确定</a>
...
<%--<div id="dialog_edit" class="dlg">
    <table>
        <tr>
            <td>Text1:</td>
            <td class="right">Text2:</td>
        </tr>
        <tr>
            <td><textarea id="textarea1" class="textbox"></textarea></td>
            <td class="right"><textarea id="textarea2" class="textbox"></textarea></td>
        </tr>
    </table>
</div>
<div id="dialog_btn">
    <a href="#" id="save" class="easyui-linkbutton">Save</a>
    <a href="#" id="close" class="easyui-linkbutton">Close</a>
</div>--%>
<%--控制台--%>
<div
